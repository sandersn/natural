...
import TransformationRule = require("./TransformationRule");
...
export function parse(input: string, options: { startRule?: string } = {}) {
    var peg$FAILED = {},

    peg$startRuleFunctions = { transformation_rules: peg$parsetransformation_rules } as { [s: string]: () => {} },
    peg$startRuleFunction  = peg$parsetransformation_rules,

    peg$c0 = [],
    peg$c1 = peg$FAILED,
    peg$c2 = function(rules: string[][]) {
        var result = [];
    ...
    peg$c3 = null as null,
    peg$c4 = function(c1: string, c2: string, pred: string, par1: string, par2: string) {
        // Construct rule
    ...
    peg$c7 = function(characters: string[]) {
        var s = "";
    ...
    peg$maxFailPos       = 0,
    peg$maxFailExpected  = [] as Expected[],
    peg$silentFails      = 0,
    ...
    function peg$computePosDetails(pos: number) {
        function advance(details: {seenCR: boolean, line: number, column: number }, startPos: number, endPos: number) {
            var p, ch;
    ...
    function peg$fail(expected: Expected) {
...
.replace(/\f/g,   '\\f')
.replace(/\r/g,   '\\r')
.replace(/[\x00-\x07\x0B\x0E\x0F]/g, function(ch: string) { return '\\x0' + hex(ch); })
.replace(/[\x10-\x1F\x80-\xFF]/g,    function(ch: string) { return '\\x'  + hex(ch); })
.replace(/[\u0180-\u0FFF]/g,         function(ch: string) { return '\\u0' + hex(ch); })
.replace(/[\u1080-\uFFFF]/g,         function(ch: string) { return '\\u'  + hex(ch); });

            }

            var expectedDescs = new Array(expected.length) as string[],
    ...
    function peg$parsetransformation_rule() {
        var s0, s1: any, s2: any, s3: any, s4: any, s5: any;
